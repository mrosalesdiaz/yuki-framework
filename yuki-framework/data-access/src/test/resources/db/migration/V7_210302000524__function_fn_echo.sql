CREATE OR REPLACE FUNCTION fn_echo_function ( v_string varchar, v_integer integer, v_double numeric, v_boolean boolean, v_instant date, v_timestamp timestamp, v_inputstream bytea)
